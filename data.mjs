export const APP_VERSION = "pretest-web-v5-2026-09-13";
...
export const eligibility = {
  EL1: "A real individual is linked to the representation because their data, participation, or identity was used to create or train it.",
  ...
  EL5: "Both are present in the proposed marketplace design:",
};

export const eligibilityParts = {
  EL5: [
    "Controlled enterprise access limited to approved uses.",
    "A defined rule for allocating payment or other attributable value to contributors.",
  ],
};
...
export const requirements = {
  ...
  DR4: { domain: "D2", label: "Contributor information distinguishes data types and states processing details", text: "Contributor-facing information:", statementParts: ["Distinguishes data supplied by contributors, data observed about them, and inferred data.", "States purposes, recipient classes, retention periods, transfers, and material automated processing."], evidence: "Notice versions, data map, recipient register, and comprehension test" },
  ...
  DR14: { domain: "D5", label: "Evaluation, uncertainty communication, output disclosure, and human fallback defined", text: "For the intended decision context, the design defines:", statementParts: ["Fit-for-purpose evaluation.", "Output limitations and uncertainty communication.", "Disclosure that outputs are simulated.", "Monitoring.", "Human fallback when confidence is insufficient."], evidence: "Evaluation report, model card, output marking, monitoring plan, and fallback test" },
  ...
  DR16: { domain: "D6", label: "Named pre-release gates and owners control purpose, privacy, outputs, and changes", text: "Before release, named accountable owners document decisions for:", statementParts: ["Purpose and roles.", "Contributor agency.", "Privacy, security, processors, and transfers.", "Buyer use and output integrity.", "Incidents and material changes."], evidence: "Completed release-gate record, named owners, change log, incident plan, and escalation decisions" },
};
