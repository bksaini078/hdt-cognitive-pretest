export const APP_VERSION = "pretest-web-v3-2026-09-13";
...
export const eligibilityNotes = {
  ...
  EL5: "The design needs both a controlled way for enterprise buyers to access approved uses and a separate rule explaining how payment or other attributable value is allocated.",
};
...
export const requirements = {
  ...
  DR4: { domain: "D2", label: "Contributor information distinguishes data types and states processing details", text: "Contributor-facing information distinguishes supplied, observed, and inferred data and states purposes, recipient classes, retention, transfers, and material automated processing.", guidance: "Read this as one disclosure requirement covering data types, purposes, recipient classes, retention, transfers, and material automated processing.", elements: ["Supplied, observed, and inferred data", "Purposes and recipient classes", "Retention and transfers", "Material automated processing"], evidence: "Notice versions, data map, recipient register, and comprehension test" },
  ...
  DR16: { domain: "D6", label: "Named pre-release gates and owners control purpose, privacy, outputs, and changes", text: "Purpose and role definition, contributor agency, privacy and security, processors and transfers, buyer use, output integrity, incidents, and material changes are controlled by named pre-release gates and accountable owners.", guidance: "This is an accountability requirement: each listed area must have a named release decision and an accountable owner before use.", elements: ["Purpose, roles, and contributor agency", "Privacy, security, processors, and transfers", "Buyer use and output integrity", "Incident response, material changes, and accountable release decisions"], evidence: "Completed release-gate record, named owners, change log, incident plan, and escalation decisions" },
};
