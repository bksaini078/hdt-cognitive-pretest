...
export const participantInformation = {
  ...
  researcher: "[NAME]",
  institutionContact: "[INSTITUTION / EMAIL]",
...
export const routes = {
  T: { label: "Taxonomy and Information Systems methods", duration: "10 to 25 minutes", eligibility: ["EL1", "EL2", "EL5"], requirements: ["DR1", "DR2", "DR4", "DR14", "DR15", "DR16"], domains: ["D1", "D2", "D5", "D6"], economics: [] },
  E: { label: "Platform economics and market research", duration: "10 to 25 minutes", eligibility: ["EL4", "EL5"], requirements: ["DR5", "DR7", "DR8", "DR11", "DR12", "DR15"], domains: ["D2", "D3", "D4", "D5", "D6"], economics: ["EC1", "EC2", "EC3", "EC4", "EC5", "EC6"] },
  G: { label: "Privacy and governance", duration: "up to 30 minutes", eligibility: ["EL1", "EL3", "EL4"], requirements: ["DR1", "DR2", "DR3", "DR4", "DR6", "DR7", "DR12", "DR13", "DR16"], domains: ["D1", "D2", "D3", "D5", "D6"], economics: [] },
  A: { label: "AI and data architecture", duration: "up to 30 minutes", eligibility: ["EL2", "EL3", "EL4"], requirements: ["DR3", "DR5", "DR9", "DR10", "DR11", "DR12", "DR13", "DR14", "DR15", "DR16"], domains: ["D1", "D2", "D4", "D5", "D6"], economics: [] },
};