export const APP_VERSION = "pretest-web-v4-2026-09-13";
...
export const eligibility = {
  ...
  EL5: "The proposed marketplace design includes both controlled enterprise access to approved uses and a defined rule for allocating payment or other attributable value to contributors.",
};
...
export const eligibilityNotes = {
  ...
  EL5: "Both parts are required: approved enterprise access and a rule that states how contributors receive payment or other attributable value.",
};
...
export const requirements = {
  ...
  DR2: { domain: "D1", label: "Authorization bound to defined purposes or query classes", text: "Authorization is bound to defined purposes, studies, use categories, or query classes rather than unrestricted downstream use.", guidance: "Downstream use means a later query, study, client use, training use, or decision-support activity involving the contributed data, representation, or its outputs.", evidence: "Purpose taxonomy, authorization record, and policy-enforcement test" },
  ...
  DR4: { domain: "D2", label: "Contributor information distinguishes data types and states processing details", text: "Contributor-facing information distinguishes data supplied by contributors, data observed about them, and inferred data. It also states the purposes, recipient classes, retention periods, transfers, and material automated processing.", guidance: "Judge one transparency requirement with two parts: distinguishing the three data types and stating how those data are processed.", elements: ["Data supplied by contributors, data observed about them, and inferred data", "Purposes and recipient classes", "Retention periods and transfers", "Material automated processing"], evidence: "Notice versions, data map, recipient register, and comprehension test" },
  ...
  DR11: { domain: "D4", label: "Quality and cohort-matching rules define release thresholds", text: "Quality, freshness, coverage, diversity, and cohort-matching rules define release thresholds and the consequence when a requested cohort cannot satisfy them.", guidance: "This asks whether minimum data-quality and cohort-coverage conditions are defined before answering a buyer query, including what the system does when those conditions are not met.", evidence: "Metric definitions, threshold rationale, cohort-fill test, and abstention record" },
  ...
  DR14: { domain: "D5", label: "Evaluation, uncertainty communication, output disclosure, and human fallback defined", text: "For the intended decision context, the design defines fit-for-purpose evaluation, output limitations and uncertainty communication, disclosure that outputs are simulated, monitoring, and human fallback when confidence is insufficient.", guidance: "Judge whether the design defines how outputs are evaluated, qualified, disclosed, monitored, and referred to a person when confidence is insufficient.", elements: ["Fit-for-purpose evaluation", "Output limitations and uncertainty communication", "Disclosure that outputs are simulated", "Monitoring and human fallback"], evidence: "Evaluation report, model card, output marking, monitoring plan, and fallback test" },
  ...
  DR16: { domain: "D6", label: "Named pre-release gates and owners control purpose, privacy, outputs, and changes", text: "Before release, named accountable owners decide whether requirements are met for purpose and roles; contributor agency; privacy, security, processors, and transfers; buyer use and output integrity; and incidents and material changes.", guidance: "Judge one accountability requirement: each listed area needs a documented decision by a named owner before release.", elements: ["Purpose and roles", "Contributor agency", "Privacy, security, processors, and transfers", "Buyer use and output integrity", "Incidents and material changes"], evidence: "Completed release-gate record, named owners, change log, incident plan, and escalation decisions" },
};
